...
import org.deadmaze.database.embeds.ReportReporter;
...
import org.deadmaze.packets.send.legacy.C_ReportAnswer;
import org.deadmaze.packets.send.modopwet.*;
...
public final class ParseModopwet {
    ...
    public void sendBanDef(String playerName, String reason, boolean isMuted) {
        ...
        if(playerClient != null) {
            ...
            playerClient.sendOldPacket(new C_BanMessageLogin(reason));
        }
    }
    ...
    public void sendBanHack(String playerName, boolean isMuted) {
        ...
        if(playerClient != null) {
            ...
            playerClient.sendOldPacket(new C_BanMessageLogin(banHours, "$MessageTriche"));
        }
    }
    ...
    public void sendWatchReport(String playerName, boolean isFollowing) {
        ...
        if(playerClient != null) {
            if(isFollowing) {
                this.client.sendEnterRoom(playerClient.getRoom().getRoomName());
            } else {
